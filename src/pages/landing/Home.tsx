  ...
  const testimonials = [
    {
      ...
      content:
        "Quantum Connects has transformed how I handle calls. I'm no longer tied to my phone, and I've increased bookings by 40%.",
      rating: 5,
    },
    {
      ...
      role: "Electrician",
      content:
        "The AI sounds so natural that customers don't even realize they're talking to a machine. Incredible value.",
      rating: 5,
    },
    {
      name: "Emma Thompson",
      ...
      content:
        "Setup was painless, and the support team is fantastic. This is a game-changer for SMBs.",
      rating: 5,
    },
  ];
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              relationships—all in one intelligent platform.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-muted/40">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Get set up with personalized support. Our onboarding team ensures
              your AI receptionist is perfectly configured for your business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Fill out your business details and preferences",
              },
              {
                step: "3",
                title: "Personalized Configuration",
                description:
                  "We customize your AI receptionist for your specific needs",
              },
              {
                step: "4",
                title: "Go Live",
              ...
              {[
                {
                  ...
                  description: "Most callers hang up if no one answers. Quantum Connects answers instantly, captures details, and ensures you never lose an opportunity again."
                },
                {
                  title: "10x Cheaper Than a Receptionist",
                  description: "No payroll, no employee management, no benefits. Get professional call handling and appointment booking at a fraction of traditional staffing costs."
                },
                {
                  title: "AI Built for Your Business",
                  description: "Unlike generic answering services, Quantum Connects learns your business specifics and handles calls exactly the way you need—no scripted, robotic responses."
                },
                {
                  title: "Complete Control, Complete Flexibility",
                  description: "Turn Quantum Connects on or off anytime. You decide when it answers calls, when it escalates to you, and how it represents your business."
                },
                {
                  title: "Live in Minutes, No Setup Hassle",
                  description: "No new phone number needed. No complex integrations. Forward your existing calls and Quantum Connects is ready to work—start taking calls today."
                },
                {
                  title: "Built for Growth",
                  description: "Advanced analytics, Google Reviews automation, deposit collection, and waitlist management—everything you need to scale your service business efficiently."
                }
              ].map((item, index) => (
